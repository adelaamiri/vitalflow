  ...
  return (
    <section className="w-full bg-[#f5f5f5] py-12 sm:py-14 lg:py-16">
      <div className="mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-14 xl:px-20">
        ...
        {/* Blog Cards */}
        <div className="mt-10 grid grid-cols-1 gap-8 sm:mt-12 md:grid-cols-2 lg:grid-cols-3 lg:gap-6">
          {blogPosts.map((post) => (
            <article key={post.id} className="group">
              ...
              {/* Title */}
              <h3 className="mt-6 max-w-[420px] text-[24px] font-medium leading-[1.3] tracking-[-0.03em] text-black sm:text-[28px]">
                {post.title}
              </h3>
